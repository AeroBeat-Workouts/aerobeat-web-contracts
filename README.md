...
- `src/body-grid-contracts.js` owns calibrated anchors, eight-way shoulder-relative cell-entry directions, calibration/readiness, tracking-safety states, and locked production defaults.
